...
<main class="container mx-auto p-6">
    <h1 class="text-3xl font-bold">Welcome to HMDecor</h1>
    <p>This is a custom-built WooCommerce theme with Tailwind CSS.</p>
    ...
    <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
        <article class="border-b border-gray-200 pb-4 mb-4">
            ...
            <a href="<?php the_permalink(); ?>" class="text-blue-600 font-bold">Read More</a>
        </article>
    <?php endwhile; else: ?>
        <p>No posts found.</p>
    <?php endif; ?>
